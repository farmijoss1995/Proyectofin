...
<body>
	...
	<header>
		...
		<a href="./carritoCompras.php" title="ver carrito de compras">
		 ...
		 <input style="font-size:20px" type="button" name="cancelar" value="ATRAS" onclick="location='menucliente.php'">
	</header>
	...
	<table class="tabla">
            ...
            <tbody>
                <tr>
                    ...
                    <td><h2 style="background: #FF0040">Contraseña</h2></td>
